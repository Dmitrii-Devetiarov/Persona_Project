...
RU = {
    ...
    # Emotionality
    "prompt_emotionality_low": (
        "отвечай как эксперт, без личного, не используй 'я'"
    ),
...
# ============================================================
    "implicit_disagreement": [
        "нет", "не согласен", "ты не прав", "неправильно", "неверно",
        "ошибся", "бред", "чушь", "ерунда", "ты чего",
        "мимо", "не то", "забудь", "прекрати", "переделывай",
        "давай заново", "не так", "не об этом"
    ],
    "implicit_correction_acceptance": [
        "да, ты прав", "ты прав", "согласен", "точно", "верно",
        "ок, принял", "исправлю", "учту", "убедил", "ладно",
        "принято", "хорошо"
    ],
    "implicit_agreement": [
        "да", "верно", "правильно", "именно", "в точку",
        "так и есть", "факт", "сто пудов", "согласен", "правда",
        "отлично", "хорошо"
    ],
    "implicit_factual_broad": [
        "а что ещё говорят", "а кроме этого", "есть другие мнения",
        "это только официальная версия", "а альтернативы",
        "неужели только так", "все так думают",
        "а если по-другому", "а как ещё можно посмотреть",
        "а другие что думают", "не только же так",
        "расскажи про другие версии", "есть ещё варианты"
    ],
    "implicit_factual_narrow": [
        "ближе к делу", "не надо всех версий",
        "я не просил перечислять", "это уже лишнее",
        "хватит альтернатив", "дай только суть",
        "зачем ты это всё рассказываешь", "я про основное спросил",
        "только главное", "без вот этого всего",
        "не уходи в сторону", "короче, основное"
    ],
    "implicit_empathy": [
        "понимаю", "сочувствую", "жаль", "мне жаль",
        "держись", "ты справишься", "всё будет хорошо",
        "не переживай", "я понимаю", "это тяжело", "это сложно",
        "я с тобой", "обнимаю"
    ],
    "implicit_dry_response": [
        "ясно", "понятно", "ок", "ага", "угу",
        "ладно", "хорошо", "принято", "бывает", "ну ок",
        "и?", "это всё", "поглядим"
    ],
    "implicit_positive_reaction": [
        "спасибо", "отлично", "здорово", "круто", "класс",
        "супер", "огонь", "шикарно", "кайф", "респект",
        "красава", "благодарю"
    ],
    "implicit_elaboration_request": [
        "подробнее", "расскажи подробнее", "распиши", "разверни",
        "продолжи", "дальше", "что ещё", "ещё", "а дальше",
        "и", "и что", "поподробнее", "не понял"
    ],
    # ============================================================
    # Messages
    # ============================================================
...
EN = {
    ...
    # ============================================================
    "implicit_disagreement": [
        "no", "i disagree", "you're wrong", "wrong", "incorrect",
        "nope", "nah", "that's wrong", "not right", "you messed up",
        "try again", "redo", "not even close", "way off",
        "nonsense", "bs", "forget it", "stop", "don't"
    ],
    "implicit_correction_acceptance": [
        "you're right", "i agree", "exactly", "true", "correct",
        "ok", "alright", "fair", "my bad", "i'll fix it",
        "good catch", "point taken", "right", "got it"
    ],
    "implicit_agreement": [
        "yes", "right", "correct", "exactly", "on point",
        "agreed", "true that", "facts", "yep", "yeah",
        "good", "great", "that's it"
    ],
    "implicit_factual_broad": [
        "what else is there", "any other views",
        "is that the only version", "what are the alternatives",
        "do others think differently", "is everyone saying that",
        "what's the other side", "are there other takes",
        "what about different opinions", "give me more perspectives",
        "is that the official story", "what else do people say"
    ],
    "implicit_factual_narrow": [
        "get to the point", "i didn't ask for all versions",
        "too many alternatives", "just the main take",
        "stop listing theories", "what's the essence",
        "why are you telling me all this", "i just wanted the basics",
        "keep it to the point", "enough with the options",
        "just the headline", "spare me the details"
    ],
    "implicit_empathy": [
        "i understand", "i'm sorry", "sorry", "hang in there",
        "you'll get through this", "it'll be okay", "don't worry",
        "i hear you", "that's hard", "that's tough",
        "i'm here for you", "that sounds really hard"
    ],
    "implicit_dry_response": [
        "i see", "got it", "ok", "okay", "uh-huh",
        "alright", "fine", "noted", "sure", "whatever",
        "and", "that it", "k", "kk"
    ],
    "implicit_positive_reaction": [
        "thanks", "thank you", "great", "awesome", "cool",
        "super", "wonderful", "excellent", "nice", "sweet",
        "love it", "perfect", "brilliant"
    ],
    "implicit_elaboration_request": [
        "more detail", "tell me more", "elaborate", "expand",
        "go on", "continue", "what else", "more",
        "and", "then", "go deeper", "expand on that"
    ],
    # ============================================================
    # Messages
    # ============================================================
